...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 mb-5">
            <img src="<?php echo e(url('images/batik1.png')); ?>" class="rounded mx-auto d-block" width="700" alt="">
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko_batik\resources\views/home.blade.php ENDPATH**/ ?>